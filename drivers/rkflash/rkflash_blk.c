...
EXPORT_SYMBOL(rkflash_dev_init);
...
EXPORT_SYMBOL(rkflash_dev_exit);
...
EXPORT_SYMBOL(rkflash_dev_suspend);
...
EXPORT_SYMBOL(rkflash_dev_resume);
...
EXPORT_SYMBOL(rkflash_dev_shutdown);
