...
rk628_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	gpiod_set_value_cansleep(rk628->enable_gpio, 1);
	usleep_range(10000, 11000);
	gpiod_set_value_cansleep(rk628->reset_gpio, 0);
	usleep_range(10000, 11000);
	gpiod_set_value_cansleep(rk628->reset_gpio, 1);
	usleep_range(10000, 11000);
	gpiod_set_value_cansleep(rk628->reset_gpio, 0);
	usleep_range(10000, 11000);
...
{
	return i2c_add_driver(&rk628_i2c_driver);
} 
